...
class Settings(BaseSettings):
    ...
    test_database_url: str = os.getenv("TEST_DATABASE_URL", "postgresql+asyncpg://testuser:testpassword@localhost:5432/test_db")
    mongodb: str = os.getenv("MONGODB", "mongodb://172.25.225.13:27017")
